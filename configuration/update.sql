...
/* 2026-03-14-1 */	UPDATE webpages SET parameters = CONCAT(IFNULL(parameters, ''), '&route=login_entry') WHERE CONCAT(identifier, IF(ending = 'none', '', ending)) = '/*_SETTING login_entry_path */';
