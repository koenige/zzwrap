...
--
-- Dumping data for table `_uri_hashes`
--

LOCK TABLES `_uri_hashes` WRITE;
/*!40000 ALTER TABLE `_uri_hashes` DISABLE KEYS */;
/*!40000 ALTER TABLE `_uri_hashes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `countries` (
  ...
  KEY `website` (`website`)
) ENGINE=MyISAM AUTO_INCREMENT=240 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `languages` (
  ...
  KEY `website` (`website`)
) ENGINE=MyISAM AUTO_INCREMENT=486 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
