 ...
 * @return bool
 */
function wrap_setting_from_page($params) {
...
/**
 * add table parameters to settings
 *
 * whitelist of possible parameters is generated from settings.cfg in modules
 * setting needs scope = table
 * @param string $scope
 * @param mixed $params
 * @param bool $reset reset values from other functions in each call
 * @return bool
 */
function wrap_setting_from_table($scope, $params, $reset = true) {
	static $unchanged = [];
	$changed = [];
